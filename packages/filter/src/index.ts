...
export function matchFilterCondition<
  T extends { _id: string; [key: string]: any },
>(data: T, condition: FilterCondition<T>) {
...
export interface Condition<Value> {
  $less?: Value;
  $lessEqual?: Value;
  $greater?: Value;
  $greaterEqual?: Value;
...
export type FilterCondition<
  TSchema extends { _id: string; [key: string]: any },
> = Partial<{
  [P in keyof TSchema]:
    | TSchema[P]
...
export type SortOrders<T = any> = Array<{
  order: "asc" | "desc";
  field: keyof T;
}>;
